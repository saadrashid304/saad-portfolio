...
export const projects: Project[] = [
  {
    ...
    stackGroups: [
      {
        label: "Frontend",
        items: ["React.js", "TypeScript", "Redux Toolkit", "Material UI"],
      },
      {
        label: "Backend",
        items: ["Java", "Spring Boot", "Spring Security", "Microservices"],
      },
      {
        label: "Data & messaging",
        items: ["MongoDB (sharding & replication)", "Apache Kafka"],
      },
      {
        label: "Infrastructure",
        items: ["Keycloak", "Docker", "Nginx", "Linux"],
      },
    ],
    availability: "Confidential project · Proprietary source code",
    features: [
      {
        id: 1,
      ...
      {
        id: 3,
        description: "Real-time monitoring, search, filtering, and updates",
      },
    ...
    gallery: [
      {
        ...
        name: "Login Screen",
        src: login,
        alt: "Lawful Interception login screen",
      },
      {
        type: "image",
        name: "Dashboard",
        src: dashboard,
        alt: "Lawful Interception dashboard",
      },
      {
        type: "image",
        name: "User Management (Keycloak)",
        src: keycloak,
        alt: "Keycloak user management screen",
      },
      {
        type: "image",
        name: "View Main Cases",
        src: viewMainCase,
        alt: "View main cases screen",
      },
      {
        type: "image",
        name: "Create Main Case",
        src: createMainCase,
        alt: "Create main case screen",
      },
      {
        type: "image",
        name: "View Sub Cases",
        src: viewSubCase,
        alt: "View sub cases screen",
      },
      {
        type: "image",
        name: "Create Sub Case - 1",
        src: createSubCase1,
        alt: "Create sub case step one",
      },
      {
        type: "image",
        name: "Create Sub Case - 2",
        src: createSubCase2,
        alt: "Create sub case step two",
      },
      {
        type: "image",
        name: "Create Sub Case - 3",
        src: createSubCase3,
        alt: "Create sub case step three",
      },
      {
        type: "image",
        name: "Update Sub Case - 1",
        src: updateSubCase1,
        alt: "Update sub case step one",
      },
      {
        type: "image",
        name: "Update Sub Case - 2",
        src: updateSubCase2,
        alt: "Update sub case step two",
      },
      {
        type: "image",
        name: "Update Sub Case - 3",
        src: updateSubCase3,
        alt: "Update sub case step three",
      },
      {
        type: "image",
        name: "View Sub Case Details",
        src: viewSubCaseDetails,
        alt: "View sub case details screen",
      },
      {
        type: "image",
        name: "View Filters",
        src: viewFilters,
        alt: "View filters screen",
      },
      {
        type: "image",
        name: "Create Filter",
        src: createFilter,
        alt: "Create filter screen",
      },
      {
        type: "image",
        name: "Update Filter",
        src: updateFilter,
        alt: "Update filter screen",
      },
      {
        type: "image",
        name: "Detask Filter",
        src: detaskFilter,
        alt: "Detask filter screen",
      },
      {
        type: "image",
        name: "View Analysis",
        src: viewAnalysisList,
        alt: "View analysis screen",
      },
      {
        type: "image",
        name: "Create Analysis",
        src: createAnalysisList,
        alt: "Create analysis screen",
      },
      {
        type: "image",
        name: "Analysis Graph Form",
        src: analysisGraphForm,
        alt: "Analysis graph form",
      },
      {
        type: "image",
        name: "Analysis Table Form",
        src: analysisTableForm,
        alt: "Analysis table form",
      },
      {
        type: "image",
        name: "Verify Audit Logs",
        src: verifyAuditLogs,
        alt: "Verify audit logs screen",
      },
      {
        type: "image",
        name: "View Manual Export",
        src: viewManualExport,
        alt: "View manual export screen",
      },
      {
        type: "image",
        name: "View Automatic Export",
        src: viewAutomaticExport,
        alt: "View automatic export screen",
      },
      {
        type: "image",
        name: "View Automatic Export Details",
        src: automaticExportDetails,
        alt: "Automatic export details screen",
      },
      {
        type: "image",
        name: "Export Folder Hierarchy",
        src: exportFolderHierarchy,
        alt: "Export folder hierarchy screen",
      },
      {
        type: "image",
        name: "Create Manual Export",
        src: createManualExport,
        alt: "Create manual export screen",
      },
      {
        type: "image",
        name: "Create Automatic Export",
        src: createAutomaticExport,
        alt: "Create automatic export screen",
      },
      {
        type: "image",
        name: "Live Monitoring (Default View)",
        src: liveDefaultView,
        alt: "Live monitoring default view",
      },
      {
        type: "image",
        name: "Live Monitoring (Folder View)",
        src: liveFolderView,
        alt: "Live monitoring folder view",
      },
      {
        type: "image",
        name: "Live Monitoring Advanced Search",
        src: liveAdvancedSearch,
        alt: "Live monitoring advanced search",
      },
      {
        type: "image",
        name: "Live Monitoring Audio Modal",
        src: liveAudioModal,
        alt: "Live monitoring audio modal",
      },
    ],
  },
  {
    ...
    features: [
      {
        id: 1,
        description: "Real-time bullet localization and coordinate tracking",
      },
      { id: 2, description: "Target visualization and scatter plot analytics" },
      {
        id: 3,
        description: "Shot grouping, session history, and accuracy analysis",
      },
    ...
    gallery: [
      {
        type: "video",
        name: "Initial Login and Main Screen",
        src: "/BulletLocalizationSystemVideos/01 - Initial login and main screen.mp4",
        alt: "Bullet Localization initial login and main screen",
      },
      {
        type: "video",
        name: "Add New Range",
        src: "/BulletLocalizationSystemVideos/02 - Add new Range.mp4",
        alt: "Adding a new shooting range",
      },
      {
        type: "video",
        name: "Add Target Station",
        src: "/BulletLocalizationSystemVideos/03 - Add Target Station.mp4",
        alt: "Adding a target station",
      },
      {
        type: "video",
        name: "Add New User",
        src: "/BulletLocalizationSystemVideos/04 - Add new user.mp4",
        alt: "Adding a new user",
      },
      {
        type: "video",
        name: "Lane Assignment",
        src: "/BulletLocalizationSystemVideos/05 - Lane assignment.mp4",
        alt: "Assigning a lane",
      },
      {
        type: "video",
        name: "User Login and Shots",
        src: "/BulletLocalizationSystemVideos/06 - User login and Shots.mp4",
        alt: "User login and shot workflow",
      },
      {
        type: "video",
        name: "History",
        src: "/BulletLocalizationSystemVideos/07 - History.mp4",
        alt: "Viewing shot history",
      },
      {
        type: "video",
        name: "Settings",
        src: "/BulletLocalizationSystemVideos/08 - Settings.mp4",
        alt: "Bullet Localization settings",
      },
    ],
  },
  {
    ...
    gallery: [
      {
        type: "image",
        name: "Landing Page",
        src: journalistLanding,
        alt: "IJournalist landing page",
      },
      {
        type: "image",
        name: "Sign In Page",
        src: journalistSignIn,
        alt: "IJournalist sign in page",
      },
      {
        type: "image",
        name: "Sign Up Page",
        src: journalistSignUp,
        alt: "IJournalist sign up page",
      },
      {
        type: "image",
        name: "Dashboard",
        src: journalistDashboard,
        alt: "IJournalist dashboard",
      },
      {
        type: "image",
        name: "Filter Management",
        src: journalistFilterManagement,
        alt: "IJournalist filter management",
      },
      {
        type: "image",
        name: "Create Filter",
        src: journalistCreateFilter,
        alt: "IJournalist create filter page",
      },
      {
        type: "image",
        name: "Filtered Articles",
        src: journalistFilterArticles,
        alt: "IJournalist filtered articles view",
      },
      {
        type: "image",
        name: "Fetched Article Details",
        src: journalistArticleDetails,
        alt: "IJournalist fetched article details",
      },
      {
        type: "image",
        name: "Article Analysis",
        src: journalistArticleAnalysis,
        alt: "IJournalist article analysis modal",
      },
      {
        type: "image",
        name: "Sentiment Graph",
        src: journalistSentimentGraph,
        alt: "IJournalist sentiment graph",
      },
      {
        type: "image",
        name: "Sentiment Graph Node Details",
        src: journalistNodeDetails,
        alt: "IJournalist sentiment graph node details",
      },
      {
        type: "image",
        name: "IJournalist Assistant",
        src: journalistAssistant,
        alt: "IJournalist assistant",
      },
    ],
    features: [
      {
        id: 1,
        description: "Automated news collection and article classification",
      },
      { id: 2, description: "AI sentiment analysis and keyword filtering" },
      {
        id: 3,
        description: "Interactive dashboards, trend charts, and reports",
      },
  ...
  },
  {
    ...
    availability: "Private project · Proprietary source code",
